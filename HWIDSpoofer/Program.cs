...
namespace HWIDSpoofer
{
    class Program
    {
        public static string textLogo = @"   ____  ____  ____      ____  _____  ______      ______   _______     ___      ___   ________  ________  _______    " + Environment.NewLine +
            ...
            @"  |____||____|     \/  \/     |_____||______.'   \______.'|_____|    `.___.'  `.___.'|_____|   |________||____| |___|" + Environment.NewLine + Environment.NewLine + Environment.NewLine +
            @"                    forked from https://github.com/Lufzys fixed by https://github.com/borsuczyna" + Environment.NewLine + Environment.NewLine; // for create ascii text signature https://www.kammerl.de/ascii/AsciiSignature.php
